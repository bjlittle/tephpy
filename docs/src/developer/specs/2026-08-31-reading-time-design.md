...
| `reference/cli.rst` | generated body | the page is a `sphinx-click` directive |
| `reference/config.rst` | generated body | the page is the `tephpy-config-options` directive of configfile spec §3.6 |
| `reference/references.rst` | generated body | the page is a `bibliography` directive |
