...
another family to take, and showing it again reclaims it (raising
:exc:`TypeError` if another family took the edge meanwhile). The out-of-the-box
diagram is unchanged. When an edge label set crowds (e.g. the default 50 hPa isobar family
...
``interval=150`` for a legible pressure scale. (:user:`claude`)
